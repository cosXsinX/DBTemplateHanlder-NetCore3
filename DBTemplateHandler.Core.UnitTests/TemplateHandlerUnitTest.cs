...
namespace DBTemplateHandler.Core.UnitTests
{
    ...
    {	
        ...
        private void InitFirstTableDescriptionPOJO()
        {
            ...
            _firstTableDescriptionPOJO.Columns = new List<ColumnDescriptor> { _primaryNotAutoColumnDescriptionPOJO, _autoColumnDescriptionPOJO };
        }
        ...
        private void InitSecondTableDescriptionPOJO()
        {
            ...
            _secondTableDescriptionPOJO.Columns = new List<ColumnDescriptor> { _primaryNotAutoColumnDescriptionPOJO, _autoColumnDescriptionPOJO };
        }
