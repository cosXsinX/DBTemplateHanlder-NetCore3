...
namespace DBTemplateHandler.Core.UnitTests
{
    ...
    {	
        ...
        {
            var provider = new TemplateContextHandlerPackageProvider<T>(new TemplateHandlerNew(null),null);
        ...
        {
            var ColumnNameColumnContextHandler = new ColumnNameColumnContextHandler(new TemplateHandlerNew(null));
            var TemplateValidator = new TemplateValidator(new TemplateHandlerNew(null),null);
        ...
        {
            var provider = new TemplateContextHandlerPackageProvider<AbstractTemplateContextHandler>(new TemplateHandlerNew(null),null); //TODO Add Interface Liskov Principle with TemplateHandlerNew
            var ColumnNameColumnContextHandler = new ColumnNameColumnContextHandler(new TemplateHandlerNew(null));
            var IsColumnNotAutoGeneratedValueColumnContextHandler = new IsColumnNotAutoGeneratedValueColumnContextHandler(new TemplateHandlerNew(null));
