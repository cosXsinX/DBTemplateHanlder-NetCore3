...
{
    [TestFixture]
    public class IsIndexedColumnAFirstIndexedColumnContextHandlerUnitTests
    {
        private IsIndexedColumnAFirstIndexedColumnContextHandler _tested;
        ...
        {
            Assert.AreEqual("Is replaced by the inner context when the current column is the first column from the iterated indexed column collection", _tested.ContextActionDescription);
        }
        ...
        [Test]
        public void ProcessContextShouldReturnAnEmptyStringWhenTheIndexedColumnModelIsNotTheFirstIndexedColumnModel()
        {
        ...
        [Test]
        public void ProcessContextShouldReturnAnContextStringValueWhenTheIndexedColumnModelIsTheFirstIndexedColumnModel()
        {
            var columnModel = new ColumnModelForTest() { IsIndexed = true };
            var databaseContext = new ProcessorDatabaseContext()
            {
        ...
        public void ProcessContextShouldReturnAnContextStringValueWhenTheIndexedColumnModelIsTheFirstIndexedColumnModelButNotTheFirstElementOfColumn()
        {
            ...
            {
                Column = columnModel,
                Table = new TableModelForTest() { Columns = new List<IColumnModel>() { new ColumnModelForTest() { Name = "Another column which is not indexed" },
