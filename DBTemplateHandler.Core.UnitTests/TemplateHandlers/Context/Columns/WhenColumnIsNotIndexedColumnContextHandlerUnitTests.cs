...
namespace DBTemplateHandler.Core.UnitTests.TemplateHandlers.Context.Columns
{
    ...
    public class WhenColumnIsNotIndexedColumnContextHandlerUnitTests
    {
        ...
        {
            _tested = new WhenColumnIsNotIndexedColumnContextHandler(new TemplateHandlerNew(null));
        }
        ...
        {
            Assert.AreEqual("Is replaced by the inner content when current column is not indexed, instead it will be replaced by an empty string", _tested.ContextActionDescription);
        }
        ...
        {
            _tested.ColumnModel = new ColumnModelForTest() { IsIndexed = true };
