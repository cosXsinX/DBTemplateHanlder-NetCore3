    ...
    public class IsAutoColumnNotAFirstAutoColumnContextHandlerUnitTests
    {
        ...
        public void ProcessContextShouldReturnAnContextStringValueWhenTheAutoGeneratedValueColumnModelIsNotTheFirstAutoGeneratedValueColumnModel()
        {
            ...
            var databaseContext = new ProcessorDatabaseContext()
            {
                ...
                { 
                    ...
                    { 
                        new ColumnModelForTest() { Name = "Another Auto Generated Value Column", IsAutoGeneratedValue = true }, columnModel 
                    } 
                }
            };
        ...
        public void ProcessContextShouldReturnAnEmptyStringWhenTheAutoGeneratedValueColumnModelIsTheFirstAutoGeneratedValueColumnModelButNotTheFirstElementOfColumn()
        {
            ...
            var databaseContext = new ProcessorDatabaseContext()
            {
                ...
                Table = new TableModelForTest()
                {
                    Columns = new List<IColumnModel>() { new ColumnModelForTest() { Name = "Another column which is not Auto Generated Value" },
                        columnModel, new ColumnModelForTest() { Name = "Another Auto Generated Value Column", IsAutoGeneratedValue = true } }
                }
            };
            var actual = _tested.ProcessContext($"{_tested.StartContext}HelloWorld{_tested.EndContext}", databaseContext);
