...
namespace DBTemplateHandler.Core.UnitTests.TemplateHandlers.Context.Table
{
    ...
    public class WhenHasNotIndexColumnTableContextHandlerUnitTests
    {
        ...
        public void OneTimeSetUp()
        {
            ...
            _tested = new WhenHasNotIndexColumnTableContextHandler(templateHandlerNew);
        }
        ...
        {
            _tested.TableModel = new TableModel(){ Columns = new List<IColumnModel>() { new ColumnModel() { IsIndexed = true, } } };
        ...
        public void ShouldReturnContextContentWhenTheTableHasNotIndexedColumn()
        {
            ...
            {
                Columns = new List<IColumnModel>(){ new ColumnModel(){IsIndexed = false,} }
            };
            var contextContent = "Hello World !";
            var result = _tested.processContext($"{_tested.StartContext}{contextContent}{_tested.EndContext}");
