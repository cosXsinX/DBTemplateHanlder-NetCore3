    ...
    public class TemplateContextHandlerRegister
    {
        ...
        public TemplateContextHandlerRegister(TemplateHandlerNew templateHandlerNew, IList<ITypeMapping> typeMappings)
        {
            ...
            new List<ITemplateContextHandler>()
            {
                ...
                new IsNotIndexedColumnAFirstIndexedColumnContextHandler(templateHandlerNew),
                new IsNotIndexedColumnALastIndexedColumnContextHandler(templateHandlerNew),
                new IsNotIndexedColumnNotAFirstIndexedColumnContextHandler(templateHandlerNew),
                new IsNotIndexedColumnNotALastIndexedColumnContextHandler(templateHandlerNew),
                new WhenColumnIsIndexedColumnContextHandler(templateHandlerNew),
                new WhenColumnIsNotIndexedColumnContextHandler(templateHandlerNew),
