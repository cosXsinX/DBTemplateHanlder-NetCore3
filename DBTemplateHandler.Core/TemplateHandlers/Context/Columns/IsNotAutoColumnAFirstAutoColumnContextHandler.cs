...
{
    public class IsNotAutoColumnAFirstAutoColumnContextHandler : AbstractColumnTemplateContextHandler
    {

        public IsNotAutoColumnAFirstAutoColumnContextHandler(TemplateHandlerNew templateHandlerNew) : base(templateHandlerNew) { }
        public override string StartContext => "{:TDB:TABLE:COLUMN:NOT:AUTO:FOREACH:CURRENT:IS:FIRST:COLUMN(";
