...
namespace DBTemplateHandler.Core.TemplateHandlers.Handlers
{
    public class TemplateHandler : ITemplateHandler
    {
        ...
        {
            return HandleDatabaseTemplate(templateString, databaseContext.Database);
        }

        public string HandleFunctionTemplate(string templateString, IDatabaseContext databaseContext)
        {
            return HandleFunctionTemplate(templateString, databaseContext.Database, databaseContext.Table, databaseContext.Column, databaseContext.ForeignKeyConstraint);
        }

        public string HandleTableColumnTemplate(string templateString, IDatabaseContext databaseContext)
        {
            return HandleTableColumnTemplate(templateString, databaseContext.Column);
        }

        public string HandleTableTemplate(string templateString, IDatabaseContext databaseContext)
        {
            return HandleTableTemplate(templateString, databaseContext.Table);
        }

        public string HandleTemplate(string templateString, IDatabaseContext databaseContext)
        {
            return HandleTemplate(templateString, databaseContext.Database, databaseContext.Table, databaseContext.Column, databaseContext.ForeignKeyConstraint);
        }
    }
}
